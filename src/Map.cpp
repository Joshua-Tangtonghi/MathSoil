...
{
    // Skybox
    Skybox2[0] = SOIL_load_OGL_texture("img/Skybox2(2).bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox2[1] = SOIL_load_OGL_texture("img/Skybox2(1).bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox2[2] = SOIL_load_OGL_texture("img/Skybox2(4).bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox2[3] = SOIL_load_OGL_texture("img/Skybox2(6).bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox2[4] = SOIL_load_OGL_texture("img/Skybox2(5).bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox2[5] = SOIL_load_OGL_texture("img/Skybox2(3).bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    ...
    Skybox[1] = SOIL_load_OGL_texture("img/skybox4.bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox[2] = SOIL_load_OGL_texture("img/skybox5.bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox[3] = SOIL_load_OGL_texture("img/skybox2.bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
    Skybox[4] = SOIL_load_OGL_texture("img/skybox3.bmp",SOIL_LOAD_AUTO,SOIL_CREATE_NEW_ID,SOIL_FLAG_MIPMAPS | SOIL_FLAG_INVERT_Y | SOIL_FLAG_NTSC_SAFE_RGB | SOIL_FLAG_COMPRESS_TO_DXT);
...
void Map::DrawGround()
{
    ...
    b->SetTexture(BACK, ListeTextures[(currentTextureIndex + 1) % 20]);
    b->SetTexture(TOP, ListeTextures[(currentTextureIndex + 2) % 20]);
    b->SetTexture(BOT, ListeTextures[(currentTextureIndex + 3) % 20]);
    b->SetTexture(RIGHT, ListeTextures[(currentTextureIndex + 4) % 20]);
    b->SetTexture(LEFT, ListeTextures[(currentTextureIndex + 5) % 20]);
    b->SetTexture(SPHERE, ListeTextures[(currentTextureIndex + 6) % 20]);
    b->Draw();
}
...
void Map::DrawSkybox(Camera *cam)
{
    ...
    GLuint* currentSkybox = useSkybox2 ? Skybox2 : Skybox;
...
void Map::SwitchSkybox()
{
    useSkybox2 = !useSkybox2;
}
void Map::SwitchTextures() {
    // Incrémente l'indice de la texture actuelle
    currentTextureIndex = (currentTextureIndex + 1) % 20; // Assure de boucler entre 0 et 19
}
